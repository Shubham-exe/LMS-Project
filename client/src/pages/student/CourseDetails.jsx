                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <p className="font-medium text-gray-800">{chapter.chapterTitle || `Chapter ${chapter.chapterOrder}`}</p>

                    </div>

                    <p className="text-sm text-gray-500">
                      Chapter {chapter.chapterOrder} • {(chapter?.chapterContent || []).length} Lectures • {calculateChapterTime(chapter)}
                    </p>
        ...
        <div className="shadow-lg rounded bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <button
              ...
              className="mt-6 w-full py-3 rounded bg-blue-600 hover:bg-blue-700 transition text-white"
            >
